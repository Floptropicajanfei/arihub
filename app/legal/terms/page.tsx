export default function TermsPage() {
  return (
    <main className="page legal-page">
      ...
      <h2>General ToS</h2>
      <ul>
        <li>These Terms apply to all services listed on my website or otherwise provided.</li>
        <li>All communication must take place through agreed contact methods (email or Discord).</li>
        <li>Services are digital and non-physical; no shipping is required.</li>
        <li>All pricing is listed in GBP (£) unless otherwise stated.</li>
        <li>I reserve the right to refuse or cancel service for any reason.</li>
        <li>Any form of harassment or abuse towards the service provider will result in immediate cancellation.</li>
        <li>You are responsible for providing accurate details and requirements before work begins.</li>
        <li>Revisions must be requested within the agreed time frame.</li>
        <li>Violation of these Terms may lead to a service ban or refusal of future work.</li>
      </ul>

      <h2>Payment and Pricing</h2>
      <ul>
        <li>Prices start at the amounts displayed on the website but may vary depending on complexity.</li>
        <li>Payment must be made through approved methods (PayPal, Stripe, or otherwise agreed).</li>
        <li>Full payment or a deposit is required before the project begins.</li>
        <li>Refunds are not available.</li>
        <li>A £20 deposit is required to secure your order and is included in the total price.</li>
        <li>Taxes and payment fees (if applicable) are the client’s responsibility.</li>
        <li>Currency conversions may affect the final amount received.</li>
        <li>Price adjustments may occur over time without notice but will not affect confirmed orders.</li>
      </ul>
      ...
      <ul>
        <li>I am not responsible for damages, loss, or data issues after delivery.</li>
        ...
        <li>I am not liable for indirect or consequential damages.</li>
        <li>All services are governed under UK law.</li>
      </ul>

      <h2>Discounts &amp; Promotional Offers</h2>
      <ul>
        <li>Discounts are valid only during the stated promotional period.</li>
        ...
        <li>Promotional bonuses cannot be requested outside the event.</li>
      </ul>
      ...
      <ul>
        ...
        <li>Requests outside official channels may be ignored.</li>
        <li>Clients must keep contact details accurate.</li>
      </ul>

      <h2>Service Rules &amp; Client Responsibilities</h2>
      <ul>
        ...
        <li>Clients must back up files after delivery.</li>
      </ul>

      <h2>Website Rules &amp; Usage</h2>
      <ul>
        <li>The website may only be used for lawful purposes.</li>
        <li>Copying, scraping, or reverse-engineering content is prohibited.</li>
        <li>Pricing and services may change without notice.</li>
        <li>Impersonation is not allowed.</li>
        <li>Malicious actions will result in service bans.</li>
        <li>Website downtime does not create liability.</li>
        <li>All content is protected by copyright.</li>
        <li>Reviews must reflect genuine experiences.</li>
        <li>Website use implies acceptance of these Terms.</li>
      </ul>

      <h2>Messaging &amp; Interaction Rules</h2>
      <ul>
        <li>Messages must remain respectful and service-related.</li>
        <li>Threats, harassment, or rude language end communication with no refund.</li>
        <li>Repeated update requests are not allowed.</li>
        <li>Communication may pause due to emergencies or workload.</li>
        <li>Requests for unpaid work or free samples will be denied.</li>
        <li>False or misleading information may cancel service.</li>
        <li>Concerns must be raised constructively.</li>
        <li>Message logs may be stored for safety or history.</li>
        <li>Ignored messages do not remove client responsibility.</li>
      </ul>

      <h2>Privacy &amp; Data Handling</h2>
      <ul>
        <li>Client information is stored securely and used only for service purposes.</li>
        <li>All project files and sensitive data are deleted after completion.</li>
        <li>Data is never sold or shared unless required by law.</li>
        <li>Communication logs may be retained for verification.</li>
      ...
      <ul>
        <li>Refunds are not available unless explicitly stated.</li>
      ...
      <h2>Hosting Terms</h2>
      <ul>
        <li>Hosting is provided through third-party providers.</li>
        <li>Hosting setup applies only to included services.</li>
        <li>Hosting fees must be paid on time.</li>
        <li>Late payment may result in temporary suspension.</li>
        <li>I am not responsible for third-party outages.</li>
        <li>Hosted services may not be used for illegal activities.</li>
        <li>Hosting plans may be adjusted upon request.</li>
        <li>Hosting may be suspended for abuse.</li>
        <li>Clients must back up hosted data.</li>
        <li>No guaranteed response time for technical issues.</li>
      </ul>

      <h2>Client Conduct</h2>
      <ul>
        <li>Clients must act respectfully and professionally.</li>
      ...
      <ul>
        <li>Reasonable security measures are used to protect data.</li>
        <li>Sensitive information is not disclosed unless legally required.</li>
        <li>Clients are responsible for their own system security.</li>
        <li>I am not liable for client-side security breaches.</li>
        <li>Hosted systems are configured securely but must be maintained by clients.</li>
